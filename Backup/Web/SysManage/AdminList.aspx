<%@ Page Language="C#"  AutoEventWireup="true" CodeFile="AdminList.aspx.cs" Inherits="SysManage_AdminList" %>
...
<body>
    ...
    <h1><a href="Main.aspx">众拓网站后台管理中心</a> - 管理员信息列表</h1>
        <div class="form-div">
            <table border="0" cellpadding="0" cellspacing="0" style="color:#192e32; width:718px;font: 12px 宋体;">
                <tr>
                    ...
                    <td style=" width:300px;">欢迎来到用户管理专区—— <a href="AdminAdd.aspx">添加用户</a></td>
                </tr>
            </table>
        </div>
        <div class="main-div">
            <table style="vertical-align:middle;text-align:center; width: 718px; background-color:#bbdde5; font: 12px 宋体;">
            <tr><td style="vertical-align: top">
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="AdminNo" HeaderText="用户名">
                            <ItemStyle HorizontalAlign="Center" Width="20%" />
                        </asp:BoundField>
                        <asp:BoundField DataField="RoleNo" HeaderText="用户角色">
                            <ItemStyle HorizontalAlign="Center" Width="20%" />
                        </asp:BoundField>
                         <asp:BoundField DataField="IsLockedOut" HeaderText="锁定用户">
                            <ItemStyle HorizontalAlign="Center" Width="20%" />
                        </asp:BoundField>
                        ...
                        <asp:TemplateField HeaderText="操作">
                            <ItemTemplate>
                                <a href="AdminEdit.aspx?AdminID=<%# Eval("AdminID") %>">编辑</a>
