<%@ Page Language="C#"  AutoEventWireup="true" CodeFile="ProductTypeAdd.aspx.cs" Inherits="SysManage_ProductTypeAdd" Title="众拓网站后台管理中心" %>
...
<h1><a href="Main.aspx">众拓网站后台管理中心</a> - 产品类别添加</h1>
        <div class="form-div">
            <table border="0" cellpadding="0" cellspacing="0" style="color:#192e32; width:718px;font: 12px 宋体;">
                <tr>
                    ...
                    <td style="width: 400px;">欢迎来到产品类别管理专区——<a href="ProductTypeList.aspx">返回产品类别列表</a></td>
                </tr>
            </table>
        </div>
        <div class="main-div">
