<%@ Page Language="C#"   AutoEventWireup="true" CodeFile="ZhaoPinAdd.aspx.cs" Inherits="SysManage_ZhaoPinAdd" %>
...
<body>
    ...
    <h1>
           <span><a href="Main.aspx">众拓网站后台管理中心</a> - 招聘信息添加 </span>
        </h1>
        <div class="form-div">
            ...
            <table cellpadding="3" cellspacing="1" border="0" style="background-color:#bbdde5; width:718px; font: 12px 宋体;">
                ...
                <tr>
                    ...
                    <td style="background-color:#ffffff; text-align: left;"> 
                           <asp:TextBox ID="txtEndDate" runat="server" Width="150px"></asp:TextBox></td>
                </tr>
                <tr>
