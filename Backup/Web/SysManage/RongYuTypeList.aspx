<%@ Page Language="C#"  AutoEventWireup="true" CodeFile="RongYuTypeList.aspx.cs" Inherits="SysManage_RongYuTypeList" Title="众拓网站后台管理中心" %>
...
<h1><a href="Main.aspx">众拓网站后台管理中心</a> - 企业荣誉类别列表</h1>
        <div class="form-div">
            <table border="0" cellpadding="0" cellspacing="0" style="color:#192e32; width:718px;font: 12px 宋体;">
                <tr>
                    ...
                    <td style="width: 300px;" align="left">欢迎来到企业荣誉类别专区 ——<a href="RongYuTypeAdd.aspx">添加荣誉新类别</a></td>
                </tr>
            </table>
        </div>
        <div class="main-div">
                    ...
                    <Columns>
                        ...
                        <ItemStyle HorizontalAlign="Center" Width="10%" Height="25px" />
                            <ItemTemplate>
                                ...
                                <asp:Label ID="lblRongYuTypeID" runat="server" Text='<%# Eval("RongYuTypeID") %>'></asp:Label>
                            </ItemTemplate>
                            <HeaderTemplate>
                                <asp:CheckBox ID="SelectAll" runat="server" OnCheckedChanged="SelectAll_CheckedChanged" Text="全选" AutoPostBack="True" />
                            </HeaderTemplate>
                        </asp:TemplateField>
                        <asp:BoundField DataField="RongYuTypeName" HeaderText="类别标题">
                            <ItemStyle HorizontalAlign="Center" Width="25%" />
                        </asp:BoundField>
                        <asp:BoundField DataField="RongYuTypeOrder" HeaderText="类别排序">
                        ...
                        <asp:TemplateField HeaderText="操作">
                            <ItemTemplate>
                              <a href='RongYuTypeEdit.aspx?RongYuTypeID=<%# Eval("RongYuTypeID") %>'>编辑</a>
