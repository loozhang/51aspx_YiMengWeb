<%@ Page Language="C#"  AutoEventWireup="true" CodeFile="ProductEdit.aspx.cs" Inherits="SysManage_ProductEdit" Title="众拓网站后台管理中心" %>
...
<h1><a href="Main.aspx">众拓网站后台管理中心</a> - 产品信息编辑</h1>
        <div class="form-div">
            <table border="0" cellpadding="0" cellspacing="0"  style="color:#192e32; width:718px;font: 12px 宋体;">
                <tr>
                    ...
                    <td style="width: 400px;">欢迎来到产品管理专区 —— <a href="ProductList.aspx">返回产品列表</a></td>
                </tr>
            </table>
        </div>
        <div class="main-div">
               ...
               <tr>
                ...
                <tr>
                    ...
                    <td style="text-align: left; background-color:#ffffff;">
                       <asp:FileUpload ID="txtProductImgUrl" runat="server" Width="300px" /><asp:Button ID="btnSetNoImg"  runat="server" Text="删除原图片" CssClass="button" Width="80px" OnClick="btnSetNoImg_Click" />
                    </td>
                </tr>
