...
public partial class RongYuView : System.Web.UI.Page
{
    //用于动态设置页面标题、关键字、描述
    ...
    public void ShowWebInfo()
    {
        ...
        else
        {
            try
            {
                ...
                DataSet ds = bll_WebInfo.GetList("FilePath='RongYuView.aspx?RongYuID="+RongYuID.ToString()+"'");
                ...
                {
                    DataSet ds1 = bll_WebInfo.GetList("FilePath='RongYuView.aspx'");
