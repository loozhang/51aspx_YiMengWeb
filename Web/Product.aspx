...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                        ...
                        <tr>
                            <td>
                                 <table border="0" cellpadding="0" cellspacing="0" width="720px" style ="color :#FFFFFF">
                                    <tr>
                                        <td>
                                                    ...
                                                    <table style="width: 100%; text-align: center; color :#FFFFFF">
                                                        <tr>
                                                            <td>
                                                             ...
                                                             <img alt='<%#Eval("ProductName")%>' src='SysManage/IMG/<%#Eval("ProductImgUrl")%>' style="border: 0px;" height="160px" width="210px" /></a>
