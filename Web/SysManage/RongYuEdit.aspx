<%@ Page Language="C#"  AutoEventWireup="true" CodeFile="RongYuEdit.aspx.cs" Inherits="SysManage_RongYuEdit" Title="众拓网站后台管理中心" %>
...
<h1><a href="Main.aspx">众拓网站后台管理中心</a> - 企业荣誉编辑</h1>
        <div class="form-div">
            ...
            <table cellpadding="3" cellspacing="1" border="0" style="background-color:#bbdde5; width:718px; font: 12px 宋体;">
                ...
                <tr>
                    ...
                    <td style="text-align: left; background-color:#ffffff;">
                        <asp:FileUpload ID="txtImgUrl" runat="server" Width="300px" /><asp:Button ID="btnSetNoImg"  runat="server" Text="删除原图片" CssClass="button" Width="80px" OnClick="btnSetNoImg_Click" /></td>
                </tr>
                <tr>
