<%@ Page Language="C#"  AutoEventWireup="true" CodeFile="MenuAdd.aspx.cs" Inherits="SysManage_MenuAdd" Title="众拓网站后台管理中心" %>
...
<h1><a href="Main.aspx">众拓网站后台管理中心</a> - 菜单添加</h1>
        <div class="form-div">
        ...
        <div class="main-div">
            <table style="width: 718px; background-color:#bbdde5; font: 12px 宋体;" border="0" cellpadding="3" cellspacing="1">
               ...
               <tr>
                ...
                <tr>
                    <td style="width:100px; background-color:#ffffff;">显示状态：</td>
                    <td style="width:500px; text-align: left; background-color:#ffffff;">
