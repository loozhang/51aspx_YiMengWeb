<%@ Page Language="C#"  AutoEventWireup="true" CodeFile="CompanyInfoEdit.aspx.cs" Inherits="SysManage_CompanyInfoEdit" %>
...
<body>
    <form id="Form1" runat="server">
       <h1><span><a href="Main.aspx">众拓网站后台管理中心</a> - 企业信息编辑</span></h1>
        <div class="form-div">
        ...
        <div class="main-div">
            <table cellpadding="3" cellspacing="1" border="0" style="background-color:#bbdde5; width:718px;font: 12px 宋体;">
                ...
                <tr>
                    ...
                    <td align="left" style="background-color:#ffffff;"><asp:FileUpload ID="txtImgUrl" runat="server" Width="300px" /><asp:Button ID="btnSetNoImg"  runat="server" Text="删除原图片" CssClass="button" Width="80px" OnClick="btnSetNoImg_Click" /></td>
                </tr>
                <tr>
