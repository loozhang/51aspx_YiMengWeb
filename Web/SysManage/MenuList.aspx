<%@ Page Language="C#"  AutoEventWireup="true" CodeFile="MenuList.aspx.cs" Inherits="SysManage_MenuList" Title="众拓网站后台管理中心" %>
...
<h1><a href="Main.aspx">众拓网站后台管理中心</a> - 菜单列表</h1>
        <div class="form-div">
            <table border="0" cellpadding="0" cellspacing="0" style="color:#192e32; width:718px;font: 12px 宋体;">
                <tr>
                    ...
                    <td style=" width:300px;" align="left">欢迎来到菜单管理专区 —— <a href="MenuAdd.aspx">添加菜单</a></td>
                </tr>
            </table>
        </div>
        <div class="main-div">
            <table style="vertical-align:middle;text-align:center; width: 718px; background-color:#bbdde5; font: 12px 宋体;"><tr><td style="vertical-align: top">
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="ElementID">
                        ...
                        <asp:BoundField DataField="ElementCode" HeaderText="菜单编号">
                            <ItemStyle HorizontalAlign="Center" Width="10%" />
                        </asp:BoundField>
                        <asp:BoundField DataField="ElementName" HeaderText="菜单名称">
                            <ItemStyle HorizontalAlign="Center" Width="20%" />
                        </asp:BoundField>
                        <asp:BoundField DataField="ParentCode" HeaderText="父菜单编号">
                            <ItemStyle HorizontalAlign="Center" Width="10%" />
                        </asp:BoundField>
                        <asp:BoundField DataField="ElementLink" HeaderText="链接地址">
                            <ItemStyle HorizontalAlign="Center" Width="25%" />
                        </asp:BoundField>
                        <asp:BoundField DataField="ElementShow" HeaderText="显示">
                            <ItemStyle HorizontalAlign="Center" Width="5%" />
                        </asp:BoundField>
                        <asp:TemplateField HeaderText="操作">
                            <ItemTemplate>
                                    <a href='MenuEdit.aspx?ElementID=<%# Eval("ElementID") %>'>编辑</a>
