<%@ Page Language="C#"  AutoEventWireup="true" CodeFile="NewsEdit.aspx.cs" Inherits="SysManage_NewsEdit" %>
...
<body>
 ...
 <h1><a href="Main.aspx">众拓网站后台管理中心</a> - 新闻编辑</h1>
        <div class="form-div">
            <table border="0" cellpadding="0" cellspacing="0" style="color:#192e32; width:718px;font: 12px 宋体;">
                <tr>
                    ...
                    <td style="width: 300px;" align="left">欢迎来到新闻管理专区 —— <a href="NewsList.aspx">返回新闻列表</a></td>
                </tr>
            </table>
        </div>
        <div class="main-div">
            <table cellpadding="3" cellspacing="1" border="0" style="background-color:#bbdde5; width:718px;font: 12px 宋体;">
                ...
                <tr>
                    <td style="width:100px; height:25px; background-color:#ffffff;">新闻标题：</td>
                ...
                <tr>
                    <td style="height:25px; background-color:#ffffff;">新闻图片：</td>
                    <td style="text-align:left; background-color:#ffffff;"><asp:FileUpload ID="txtImgUrl" runat="server" Width="300px" /><asp:Button ID="btnSetNoImg"  runat="server" Text="删除原图片" CssClass="button" Width="80px" OnClick="btnSetNoImg_Click" /></td>
                </tr>
                <tr>
                    <td style="height:25px; background-color:#ffffff;">新闻排序：</td>
                    <td style="text-align:left; background-color:#ffffff;"><asp:TextBox ID="txtNewsOrder" runat="server" Width="60px" autocomplete="off"  OnKeyPress="if(((event.keyCode>=48)&&(event.keyCode <=57))) {event.returnValue=true;} else{event.returnValue=false;}"  MaxLength="5"></asp:TextBox> *必须为数字</td>
                </tr>
                 <tr>
                    <td style="height:25px; background-color:#ffffff;">新闻类别：</td>
                    <td style="text-align: left; background-color:#ffffff;">
                        <asp:DropDownList ID="txtNewsType" runat="server" Width="150px">
                        </asp:DropDownList></td>
                </tr>
                <tr>
                    <td style="height:25px; background-color:#ffffff;">新闻内容：</td>
                    <td style="text-align: left; background-color:#ffffff;">
