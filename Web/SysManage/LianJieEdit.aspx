<%@ Page Language="C#"   AutoEventWireup="true" CodeFile="LianJieEdit.aspx.cs" Inherits="SysManage_LianJieEdit" %>
...
<body>
    ...
    <h1><a href="Main.aspx">众拓网站后台管理中心</a> - 友情链接编辑</h1>
        <div class="form-div">
        ...
        <div class="main-div">
            <table style="width: 718px; background-color:#bbdde5; font: 12px 宋体;" border="0" cellpadding="3" cellspacing="1">
                ...
                <tr>
                    <td style="width:100px; background-color:#ffffff;">链接标题：</td>
                ...
                <tr>
                    ...
                    <asp:FileUpload ID="txtImgUrl" runat="server" Width="300px" />
                    <asp:Button ID="btnSetNoImg"  runat="server" Text="删除原图片" CssClass="button" Width="80px" OnClick="btnSetNoImg_Click" />
                      </td>
                </tr>
                <tr>
