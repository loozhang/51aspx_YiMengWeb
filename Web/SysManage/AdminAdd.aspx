<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminAdd.aspx.cs" Inherits="SysManage_AdminAdd" %>
...
<body>
    <form id="Form1" runat="server">
       <h1><a href="Main.aspx">众拓网站后台管理中心</a> - 用户添加</h1>
        <div class="form-div">
        ...
        <div class="main-div">
            <table cellpadding="3" cellspacing="1" border="0" style="background-color:#bbdde5; width:400px;font: 12px 宋体;color: #192e32;">
                <tr>
                    <td colspan="2" style="font-weight: bold; height: 25px; background-color: #ddeef2">添加管理员</td>
                </tr>
                <tr>
                    <td style=" background-color:#ffffff; height: 25px;">用户名：</td>
                    <td style="background-color:#ffffff; text-align: left;"><asp:TextBox ID="txtAdminNo" runat="server" Width="120px"></asp:TextBox></td>
                </tr>
                 <tr>
