<%@ Page Language="C#"  AutoEventWireup="true" CodeFile="NewsTypeAdd.aspx.cs" Inherits="SysManage_NewsTypeAdd" %>
...
<h1><a href="Main.aspx">众拓网站后台管理中心</a> - 新闻类别添加</h1>
        <div class="form-div">
            <table border="0" cellpadding="0" cellspacing="0" style="color:#192e32; width:718px;font: 12px 宋体;">
                <tr>
                    ...
                    <td style="width: 300px;" align="left">欢迎来到新闻类别管理专区 —— <a href="NewsTypeList.aspx">返回新闻类别列表</a></td>
                </tr>
            </table>
        </div>
        <div class="main-div">
