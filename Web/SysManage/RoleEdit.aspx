<%@ Page Language="C#"  AutoEventWireup="true" CodeFile="RoleEdit.aspx.cs" Inherits="SysManage_RoleEdit" %>
...
<h1><a href="Main.aspx">众拓网站后台管理中心</a> - 角色编辑</h1>
        <div class="form-div">
        ...
        <div class="main-div">
            <table cellpadding="3" cellspacing="1" border="0" style="background-color:#bbdde5; width:718px; font: 12px 宋体;">
                ...
                <tr>
                    <td style="height:25px; background-color:#ffffff;">角色权限：</td>
