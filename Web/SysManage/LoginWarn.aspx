<%@ Page Language="C#"  AutoEventWireup="true" CodeFile="LoginWarn.aspx.cs" Inherits="SysManage_LoginWarn" Title="温馨提示" %>
    ...
    <form id="Form1" runat="server">
        ...
        <div class="main-div">
            <table border="0" cellpadding="0" cellspacing="0" style="height:320px;">
              <tr>
                <td>你还未登录或登录已超时，<a href="Login.aspx?action=logout"><font color="#cc3300">重新登录</font></a></td>
              </tr>
            </table> 
        </div>
