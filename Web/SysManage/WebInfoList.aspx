<%@ Page Language="C#"  AutoEventWireup="true" CodeFile="WebInfoList.aspx.cs" Inherits="SysManage_WebInfoList" %>
...
<body>
 ...
 <h1><span><a href="Main.aspx">众拓网站后台管理中心</a> - 网页关键字列表</span></h1>
        <div class="form-div">
            <table border="0" cellpadding="0" cellspacing="0" style="color:#192e32; width:718px;font: 12px 宋体;" >
                <tr>
                    ...
                    <td style="width: 300px;" align="left">欢迎来到关键字管理专区 —— <a href="WebInfoAdd.aspx">添加网页关键字</a> 
                    </td>
                </tr>
            </table>
        </div>
            ...
            <table style="vertical-align:middle; text-align:center; background-color:#bbdde5; width:718px;font: 12px 宋体;"><tr><td style="vertical-align: top">
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Title" HeaderText="关键字标题">
                            <ItemStyle HorizontalAlign="Center" Width="20%" />
                        </asp:BoundField>
                        <asp:TemplateField HeaderText="操作">
                            <ItemTemplate>
                              <a href='WebInfoEdit.aspx?ID=<%# Eval("ID") %>'>编辑</a>
                              <a href='WebInfoView.aspx?ID=<%# Eval("ID") %>'>查看</a>
...
<uc1:End ID="End1" runat="server" /><script type="text/javascript" language="javascript">parent.frames['header-frame'].document.getElementById('load-div').style.display='none';</script></form></body></html>
